  ...
  do
  {
    ...
    switch (TagHead.Typ)
    {
      ...
      case tyAnsiString:
        ...
        //fprintf(fpout, L"%s", WideBuffer);//changed since fwprintf is a super old function which no longer works
        fprintf(fpout, "%s", TagHead.Typ);
        fprintf(fpout, "<Widebufferness>");
        free(WideBuffer);
        break;
            case tyBinaryBlob:
