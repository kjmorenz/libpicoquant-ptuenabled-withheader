function Data=read_phd_mwbw(FileName)
...
% Data.NumCurves --> The number of unique traces in the filel
...
FileName='C:\Users\Minhal\Desktop\2015-08-26-SWIRTCPSC-Data.phd'
fid=fopen(FileName);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% #MWBW -- and here we assembel the useful bits into our data object
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Data.IsData = true;

Data.NumCurves = NumberOfCurves;

Data.Data=cell(NumberOfCurves,1);

for i=1:NumberOfCurves
    
    Data.Data{i}=[(Resolution(i)*(1:Channels(i)))' Counts(:,i)];

    Data.StartRate = InpRate0';
    Data.StopRate = InpRate1';
    Data.TimeStep = Resolution';
    Data.Peak = Peak';
